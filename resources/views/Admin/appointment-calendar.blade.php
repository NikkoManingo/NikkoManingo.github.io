...
<body>
				...
				<div class="page-header">
					<div class="row">
						...
						<div class="col-md-6 col-sm-12 text-right">
								<a class="btn btn btn-outline-primary" href="appointment-list.php" role="button">
								    List view
								</a>
						</div>
					</div>
						...
						<div class="modal-dialog modal-dialog-centered">
							<div class="modal-content">
								<div class="modal-body">
									...
									<div class="event-client"></div>
                                    <div class="event-pet"></div>
								...
								<form id="add-event">
									<div class="modal-body">
										...
										<div class="form-group">
											...
											<input type='text' class="datetimepicker form-control" name="date">
										</div>
									</div>
									<div class="modal-footer">
	...
	<script src="assets/scripts/appointment-setting.js"></script>
</body>
</html>