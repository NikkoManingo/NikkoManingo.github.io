		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="user-veterinarians.php">Veterinarians</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add Veterinarian</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<h4 class="text-blue h4">Veterinarian Registration</h4>
						<p class="mb-30">Fill out the registration form with the veterinarian's basic information.</p>
					</div>
