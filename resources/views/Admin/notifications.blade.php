...
<body>
	...
	<div class="main-container">
        ...
        <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
            <div class="container">
                <div class="full-notification-ui_dd-content">
                    <div class="full-notification-list full-notification-list--unread">
                        <div class="full-notification-list_content">
                            <div class="full-notification-list_img">
                                <img src="assets/images/user-sample.png" alt="user">
                            </div>
                            <div class="full-notification-list_detail">
                                <p><b>Name</b> set an appointment</p>
                ...
                <div class="text-center">
                    <a href="#!" class="dark-link">Load more...</a>
                </div>
            </div>
        </div>
    </div>
