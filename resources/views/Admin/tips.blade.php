				...
				<div class="page-header">
					<div class="row">
						...
						<div class="col-md-6 col-sm-12 text-right">
								<a class="btn btn btn-outline-primary" href="post-tips.php" role="button">
								    <i class="icon-copy fa fa-plus" aria-hidden="true"></i> Post Tips
								</a>
						</div>
					</div>
				</div>
										...
										<li>
											<div class="row no-gutters">
												<div class="col-lg-4 col-md-12 col-sm-12">
													<div class="blog-img">
														<img src="assets/images/img1.jpg" alt="" class="bg_img">
													</div>
												</div>
												<div class="col-lg-8 col-md-12 col-sm-12">
													<div class="blog-caption">
														...
														<div class="blog-by">
															...
															<div class="pt-10">
																<a href="tips-detail.php" class="btn btn-outline-primary">Read More</a>
															</div>
														</div>
													</div>
												</div>
