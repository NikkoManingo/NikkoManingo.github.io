...
<body>
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">Registered Clients</h4>
					</div>
					<div class="pb-20">
						<table class="data-table-export table stripe hover  nowrap" id="clientsTable">
							<thead>
								<tr>
									<th class="table-plus">Client ID</th>
									<th>Name</th>
									<th>Email</th>
									<th>Address</th>
									...
									<li>
										<form id="editClientForm">
											...
											<div class="form-group row">
												...
												<div class="col-md-8">
													<input type="number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="11" name="contact" id="contact" class="form-control">
												</div>
											</div>
									</li>
	...
	<script type="text/javascript">
		$(function() {
			...
			//TO GET CLIENT INFO
			$('body').on('click', '#editClient', function(data) {
				var client_id = $(this).data('id');
		
				$.get("/getClient/" + client_id, function(data) {
