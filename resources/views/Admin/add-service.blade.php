      ...
      <div class="pd-ltr-20 xs-pd-20-10">
         <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
               <div class="clearfix">
                  <h4 class="text-blue h4">Adding</h4>
                  <p class="mb-30">Fill out the required information.</p>
               </div>
               <form method="post" enctype="multipart/form-data" action="/Admin_toAddService">
                  @if($errors->all())
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="serviceName" value="{{old('serviceName')}}" required>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group">
                              <label>Starting Price :</label>
                              <input type="text" class="form-control" name="servicePrice" value="{{old('servicePrice')}}" required>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="custom-file">
                                 <input type="file" class="custom-file-input" name="serviceImage" value="{{old('serviceImage')}}" required>
                        ...
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <textarea class="form-control" name="serviceDescription" required>{{old('serviceDescription')}}</textarea>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                         ...
                         <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                               <div class="modal-body text-center font-18">
                                  ...
                                  The service has been added to the database.
                               </div>
