		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="html-editor pd-20 card-box mb-30">
					<h4 class="h4 text-blue">Edit Post</h4>
					<p>Edit the post to keep it up-to-date.</p>
                        ...
                        <div class="form-group">
                            <div class="row">
                               <div class="col-md-6 col-6">
                                  <a href="tips-detail.php" class="btn btn-outline-danger btn-block"> <i class="icon-copy fi-x"></i> Cancel</a>
                               </div>
                                
                               <div class="col-md-6 col-6">
                                  <a href="#" class="btn btn-outline-success btn-block" data-toggle="modal" data-target="#confirmation-modal" type="button"> <i class="icon-copy fi-check"></i> Save Changes </a>
