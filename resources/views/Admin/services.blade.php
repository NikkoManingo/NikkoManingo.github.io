					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-12 text-right">
							<a class="btn btn btn-outline-primary" href="/Admin_AddService" role="button">
								<i class="icon-copy fa fa-plus" aria-hidden="true"></i> Add Service
							</a>
						</div>
					</div>
				</div>
					...
					<div class="product-list">
						<ul class="row">
							...
							<li class="col-lg-4 col-md-6 col-sm-12">
								<input type="hidden" name="service_id" value="{{$services->admin_service_id}}">
								<div class="product-box">
									<div class="producct-img"><img src="{{ asset('uploads/adminPic/' . $services->service_image) }}" alt=""></div>
									<div class="product-caption">
										<h4><a href="#">{{$services->service_name}}</a></h4>
										<div class="price">
											Starting price: <ins>₱{{$services->service_price}}.00</ins>
										</div>
										<a data-id="{{$services->admin_service_id}}" href="/Admin_ServiceDetail" id="detail" class="btn btn-outline-primary">Read More</a>
									</div>
								</div>
							</li>
							@endforeach
