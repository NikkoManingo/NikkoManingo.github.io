			...
			<div class="min-height-200px">
				...
				<div class="gallery-wrap">
								...
								<div class="da-card-photo">
									...
									<div class="da-overlay">
										...
										<h5 class="mb-10 color-white pd-20">Lorem ipsum dolor sit amet, consectetur adipisicing.</h5>
											<ul class="clearfix">
												<li><a href="assets/images/img1.jpg" data-fancybox="images"><i class="fa fa-picture-o"></i></a></li>
												<li><a href="#"><i class="icon-copy fa fa-trash" aria-hidden="true"></i></a></li>
											</ul>
										</div>
									</div>
								</div>
                    ...
                    <div class="form-group">
                        <label>Add another photo to gallery :</label>
