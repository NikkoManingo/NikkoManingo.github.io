							...
							<div class="col-md-8 col-sm-12">
                                ...
                                <div class="row">
										<div class="col-md-6 col-6">
											<a href="edit-service.php" class="btn btn-primary btn-block"> <i class="icon-copy fi-page-edit"></i> Edit</a>
										</div>
                                        
										<div class="col-md-6 col-6">
											<a href="#" class="btn btn-outline-danger btn-block" data-toggle="modal" data-target="#confirmation-modal" type="button"> <i class="icon-copy fa fa-trash" aria-hidden="true"></i> Archive
                                            </a>
