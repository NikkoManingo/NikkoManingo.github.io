...
<body>
			...
			<div class="min-height-200px">
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						...
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4 class="text-blue h4">Veterinarians</h4>
							</div>
						</div>
						<div class="col-md-6 col-sm-12 text-right">
								<a class="btn btn btn-outline-primary" href="add-veterinarian.php" role="button">
								    <i class="icon-copy fa fa-plus" aria-hidden="true"></i> Add Veterinarian
								</a>
						</div>
					</div>
					</div>
	...
	<script src="assets/scripts/datatable-setting.js"></script></body>
</html>