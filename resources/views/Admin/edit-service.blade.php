		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<h4 class="text-blue h4">Editing</h4>
						<p class="mb-30">Fill out the required information.</p>
					</div>
					<form method="post" enctype="multipart/form-data" action="/Admin_toEditService">
						...
						@endif
						@csrf
						<input type="hidden" name="service_id" value="{{$service->admin_service_id}}">
						<h5>Services</h5>
						<section>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="service_code" value="{{$service->service_code}}" class="form-control">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="service_price" value="{{$service->service_price}}" class="form-control">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="custom-file">
											<input type="file" name="service_image" value="{{$service->service_image}}" class="custom-file-input">
							...
							<div class="row">
								<div class="col-md-12">
									<button type="submit" class="btn btn-outline-primary btn-block" data-toggle="modal" data-target="#success-modal">Submit</button>
                              ...
                              <div class="modal-dialog modal-dialog-centered" role="document">
                                 <div class="modal-content">
                                    <div class="modal-body text-center font-18">
                                       ...
                                       The service information has been edited.
                                    </div>
